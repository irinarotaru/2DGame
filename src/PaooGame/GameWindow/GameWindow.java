...
/*! \class GameWindow
    ...
    Primim instante din celelate clase folosite precum player, colac, umbrela, keyhandler pentru a le putea folosi mai departe
 */
public class GameWindow
{
    ...
    public int nivel=1;
    public int win=0;
    public int visited[] = new int[12];
    public int verific[] = new int[12];
    public Colac colac=new Colac();
    public Umbrela umbrela=new Umbrela();
    private Canvas  canvas;
    public CollisionChecker cChecker= new CollisionChecker(this);/*!< "panza/tablou" in care se poate desena*/
